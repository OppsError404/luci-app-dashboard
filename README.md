...
```bash
wget --no-check-certificate -O /tmp/luci-app-dashboard.apk "https://github.com/OppsError404/luci-app-dashboard/releases/download/v1.0.0-r3/luci-app-dashboard-1.0.0-r3.apk" && \
...
```bash
wget --no-check-certificate -O /tmp/luci-app-dashboard.ipk "https://github.com/OppsError404/luci-app-dashboard/releases/download/v1.0.0-r3/luci-app-dashboard_1.0.0-r3.ipk" && \
